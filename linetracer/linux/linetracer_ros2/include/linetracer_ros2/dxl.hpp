...
public:
    ...
    void linetracer_control(double linear_spd, double angular_spd, int *DXL_L, int *DXL_R);
    void convert_LARPM(double linear_spd, double angular_spd, int *Dxl_L, int *Dxl_R);
};
